          ...
          <div className="modal-body p-4">
            ...
            {successMessage && (
              <div className="alert alert-success border-0 shadow-sm mb-4" style={{ borderRadius: "12px" }}>
                <div className="d-flex align-items-center"><FontAwesomeIcon icon={faCheckCircle} className="text-success fs-5 me-3" /><div><h6 className="alert-heading mb-1 fw-bold">Succès !</h6><p className="mb-0">{successMessage}</p></div></div>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                {imagePreview ? (
                  <div className="position-relative d-inline-block">
                    ...
                    <button type="button" className="btn btn-sm btn-danger position-absolute top-0 end-0 m-1" onClick={handleRemoveImage} disabled={loading} style={{ width: "28px", height: "28px", borderRadius: "50%", padding: 0 }}><FontAwesomeIcon icon={faTrash} /></button>
                  </div>
                ) : (
                  <div className="border rounded-3 p-4 text-center" style={{ borderStyle: "dashed", borderColor: colors.oskar.grey, cursor: "pointer" }} onClick={() => fileInputRef.current?.click()}>
                    ...
                    <input ref={fileInputRef} type="file" className="d-none" accept="image/*" onChange={handleImageChange} />
                  </div>
                )}
              </div>
              ...
              <div className="d-flex justify-content-end gap-3 mt-4 pt-2 border-top">
                ...
                <button type="submit" className="btn text-white px-4" disabled={loading} style={{ background: colors.oskar.green, borderRadius: "10px" }}>
