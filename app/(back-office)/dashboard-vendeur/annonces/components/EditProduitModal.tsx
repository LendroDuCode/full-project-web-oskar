...
const EditProduitModal = ({
  ...
  useEffect(() => {
    if (produit && isOpen) {
      setFormData({
        ...
        boutiqueUuid: produit.boutiqueUuid || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.boutiqueUuid) {
        formDataToSend.append("boutiqueUuid", formData.boutiqueUuid);
      }
  ...
  const handleClose = () => {
    ...
    const hasChanges = 
      formData.libelle !== (produit?.libelle || "") ||
      formData.prix !== (produit?.prix?.toString().replace(".00", "") || "") ||
      formData.image !== null;
        ...
        >
          ...
          >
            <div className="d-flex align-items-center">
              ...
              <div>
                <h5 className="modal-title mb-0 fw-bold">Modifier le produit</h5>
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  disabled={loading}
                  placeholder="Ex: Mercedez"
                  style={{ borderRadius: "10px", padding: "0.75rem 1rem" }}
                />
                {validationErrors.libelle && (
                  <div className="invalid-feedback">{validationErrors.libelle}</div>
                )}
              </div>
              ...
              <div className="mb-3">
                  ...
                  >
                    <span>
                      {formData.categorie_uuid
                        ? categories.find(c => c.uuid === formData.categorie_uuid)?.libelle
                        : "Sélectionnez une catégorie..."}
                    </span>
                    <FontAwesomeIcon icon={faChevronDown} className="text-muted" />
                  </button>
                  <div className="dropdown-menu w-100 p-3" style={{ maxHeight: "250px", overflowY: "auto" }}>
                    <div className="mb-2">
                    ...
                    {filteredCategories.map((category) => (
                      <button
                        ...
                        onClick={() => {
                          setFormData((prev) => ({ ...prev, categorie_uuid: category.uuid }));
                          setSearchCategory("");
                        }}
                      >
                        {category.libelle}
                ...
                {validationErrors.categorie_uuid && (
                  <div className="invalid-feedback d-block">{validationErrors.categorie_uuid}</div>
                )}
              </div>
              ...
              <div className="mb-3">
                ...
                {validationErrors.prix && (
                  <div className="invalid-feedback">{validationErrors.prix}</div>
                )}
              </div>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  disabled={loading}
                  placeholder="Ex: Mercedez GLC dernier modèle"
                  style={{ borderRadius: "10px", padding: "0.75rem 1rem" }}
                />
              </div>
