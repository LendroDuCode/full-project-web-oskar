// components/dons/EditDonModal.tsx
"use client";
...
export default function EditDonModal({
  ...
  const validateForm = (): boolean => {
    ...
    if (parseInt(String(formData.quantite), 10) < 1) {
  ...
  const handleRemoveImage = () => {
    ...
    setPreviewImage(don.image || null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isAuthenticated) {
      setError("Vous devez être connecté pour modifier un don.");
      return;
    }
    ...
    try {
      ...
      formDataToSend.append("quantite", String(formData.quantite));
  ...
  const handleClose = () => {
    ...
    const hasChanges =
      formData.titre !== (don.titre || "") ||
      formData.type_don !== (don.type_don || "") ||
      formData.description !== (don.description || "") ||
      formData.localisation !== (don.localisation || "") ||
      formData.lieu_retrait !== (don.lieu_retrait || "") ||
      formData.quantite !== (don.quantite || "1") ||
      formData.nom_donataire !== (don.nom_donataire || "") ||
      formData.numero !== (don.numero || "") ||
      formData.condition !== (don.condition || "bon") ||
      formData.disponibilite !== (don.disponibilite || "immediate") ||
      formData.categorie_uuid !== (don.categorie_uuid || "") ||
      formData.image !== null;
              ...
              >
                <div className="d-flex align-items-center">
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <p className="mb-0">
                      Vous devez être connecté pour modifier un don.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="row g-4">
                ...
                <div className="col-12">
                  ...
                  <div className="text-muted mt-2">
                    <small>
                      Formats acceptés: JPG, PNG, WEBP, GIF (max 5MB). Si aucune
                      nouvelle image n'est fournie, l'image actuelle sera
                      conservée.
                    </small>
                  </div>
                </div>
