...
export default function CreateDonModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("✅ Réponse API création don:", response);
      ...
      <div className="modal-dialog modal-dialog-centered modal-xl">
        ...
        >
          ...
          <div
            ...
            style={{
              background: `linear-gradient(135deg, ${colors.oskar.green} 0%, ${colors.oskar.yellow} 100%)`,
            ...
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <p className="mb-0 opacity-75 fs-14">
                  Remplissez tous les champs pour créer un nouveau don
                </p>
              </div>
            </div>
            <button
                      ...
                      <div className="alert alert-warning border-0 mt-3 mb-0">
                        <small className="d-flex align-items-center">
                          <FontAwesomeIcon
                            ...
                            className="me-2"
                          />
                          Une photo claire augmente les chances que votre don
                          trouve preneur
                        </small>
                      </div>
                    </div>
            ...
            <div className="d-flex justify-content-between w-100">
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${colors.oskar.yellow}`,
                  borderRadius: "8px",
                  fontWeight: "500",
                }}
              >
