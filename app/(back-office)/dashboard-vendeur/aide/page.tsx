...
export default function Aide() {
  ...
  return (
    <div className="min-vh-100 bg-light">
      ...
      <div className="bg-success bg-opacity-10 border-bottom">
          ...
          <div className="row align-items-center">
            <div className="col-lg-8">
              ...
              <p className="lead text-dark mb-4">
                Guide complet pour maîtriser les ventes, échanges et dons sur
                notre plateforme
              </p>
              <div className="d-flex align-items-center">
                <Badge bg="success" className="fs-6 px-3 py-2 me-3">
                  <i className="fas fa-crown me-2"></i>
                  GUIDE PREMIUM
                </Badge>
                <span className="text-success text-opacity-75">
            ...
            <div className="col-lg-4 text-lg-end mt-4 mt-lg-0">
              <div className="bg-white rounded-3 shadow-sm p-4 d-inline-block">
                <div className="text-center">
                  <div className="text-success fw-bold fs-4">87%</div>
        ...
        <div className="border-top border-success border-opacity-25">
          <Container>
            <Nav
              variant="pills"
              className="pt-4"
            ...
            >
              <Nav.Item className="me-3 mb-3">
                <Nav.Link
                  eventKey="overview"
                  className={`rounded-pill px-4 py-3 ${activeTab === "overview" ? "bg-success text-white shadow-lg" : "bg-white text-success border border-success"}`}
                >
              ...
              <Nav.Item className="me-3 mb-3">
                <Nav.Link
                  eventKey="sales"
                  className={`rounded-pill px-4 py-3 ${activeTab === "sales" ? "bg-primary text-white shadow-lg" : "bg-white text-primary border border-primary"}`}
                >
              ...
              <Nav.Item className="me-3 mb-3">
                <Nav.Link
                  eventKey="exchanges"
                  className={`rounded-pill px-4 py-3 ${activeTab === "exchanges" ? "bg-warning text-white shadow-lg" : "bg-white text-warning border border-warning"}`}
                >
              ...
              <Nav.Item className="me-3 mb-3">
                <Nav.Link
                  eventKey="donations"
                  className={`rounded-pill px-4 py-3 ${activeTab === "donations" ? "bg-info text-white shadow-lg" : "bg-white text-info border border-info"}`}
                >
              ...
              <Nav.Item className="mb-3">
                <Nav.Link
                  ...
                  className={`rounded-pill px-4 py-3 ${activeTab === "performance" ? "bg-dark text-white shadow-lg" : "bg-white text-dark border border-dark"}`}
                >
        ...
        <Tab.Container activeKey={activeTab}>
          <Tab.Content>
                ...
                <Col lg={8}>
                  <div className="mb-5">
                    ...
                    <p className="text-dark fs-5 mb-4">
                      ...
                      transactions en ligne. Notre plateforme unique vous permet
                      non seulement de vendre, mais aussi d'échanger vos
                      articles et de faire des dons solidaires, le tout dans un
                      environnement sécurisé et optimisé pour votre succès.
                    </p>

                    <div className="bg-success bg-opacity-10 p-5 rounded-4 mb-4">
                      ...
                      <p className="mb-0 fs-5">
                        ...
                        vous offre une approche tri-dimensionnelle : générez des
                        revenus directs par les ventes, renouvelez votre
                        inventaire sans dépenser via les échanges, et contribuez
                        à l'économie circulaire grâce aux dons tout en
                  ...
                  <Row className="g-4 mb-5">
                    <Col md={4}>
                      <Card className="border-success border-2 shadow-sm h-100 hover-lift">
                        <Card.Body className="p-4">
                          ...
                          <p className="text-dark mb-3">
                            Notre système de vente intelligent analyse le marché
                            en temps réel pour vous suggérer les prix les plus
                            compétitifs. Les commissions sont réduites pour les
                            vendeurs actifs, et notre système de paiement
                            sécurisé garantit des transactions sans risque.
                          </p>
                    ...
                    <Col md={4}>
                      <Card className="border-warning border-2 shadow-sm h-100 hover-lift">
                        <Card.Body className="p-4">
                          <div className="d-flex align-items-center mb-3">
                          ...
                          <p className="text-dark mb-3">
                            L'échange OSKAR utilise une IA avancée pour évaluer
                            avec précision la valeur de vos articles et trouver
                            des correspondances parfaites. C'est la solution
                            idéale pour renouveler votre stock sans débourser
                            d'argent et sans commission sur la transaction.
                          </p>
                    ...
                    <Col md={4}>
                      <Card className="border-info border-2 shadow-sm h-100 hover-lift">
                        <Card.Body className="p-4">
                          <div className="d-flex align-items-center mb-3">
                          ...
                          <p className="text-dark mb-3">
                            ...
                            récompensés. OSKAR vous fournit un certificat de don
                            fiscal, augmente votre visibilité avec un badge
                            solidaire, et vous connecte avec des associations
                            vérifiées. Votre générosité est valorisée et
                            reconnue.
                          </p>
                  ...
                  >
                    <Card.Body className="p-4">
                      ...
                      <p className="text-muted mb-4">
                        Suivez votre évolution sur les différentes dimensions de
                        la plateforme OSKAR. Ces indicateurs vous aident à
                      ...
                      <div className="mb-4">
                        <div className="d-flex justify-content-between mb-2">
                          ...
                          <span className="fw-bold">{userProgress.sales}%</span>
                        </div>
                        <ProgressBar
            ...
            <Tab.Pane eventKey="sales">
              <div className="mb-5">
                ...
                <p className="text-dark fs-5">
                  La vente sur OSKAR va bien au-delà de la simple publication
                  d'annonces. C'est un écosystème complet conçu pour maximiser
                  votre rentabilité tout en minimisant vos efforts.
                </p>

                <div className="bg-primary bg-opacity-10 p-5 rounded-4 mb-4">
                  ...
                  <p className="mb-0 fs-5">
                    ...
                    dynamique, une communication proactive, et une optimisation
                    constante basée sur les données analytiques que nous
              ...
              <Row className="g-4">
                <Col lg={8}>
                  <Card className="border-primary border-2 shadow-lg">
                    <Card.Body className="p-5">
                      ...
                      <p className="text-dark mb-4">
                        Notre algorithme analyse en temps réel des milliers de
                        données pour vous suggérer la stratégie de prix optimale
                        selon le type de produit, la saisonnalité, et la demande
                        du marché.
                      </p>
                      ...
                      <Row className="g-4">
                        {[
                          ...
                          <Col md={6} key={idx}>
                            <div className="d-flex align-items-start p-4 bg-primary bg-opacity-5 rounded-3 h-100">
                              <i
                  ...
                  <Card className="border-success border-2 shadow-lg mt-4">
                    <Card.Body className="p-5">
                      ...
                      <p className="text-dark mb-4">
                        ...
                        annonces avec des photos professionnelles voient leur
                        taux de conversion augmenter de 300%.
                      </p>
                          ...
                          <div className="bg-success bg-opacity-5 p-4 rounded-3 h-100">
                            ...
                            <ListGroup variant="flush">
                              <ListGroup.Item className="border-0 py-2 bg-transparent">
                                ...
                                Évitez les flashs et lumières artificielles
                              </ListGroup.Item>
                              <ListGroup.Item className="border-0 py-2 bg-transparent">
                                <i className="fas fa-th-large text-success me-2"></i>
                                <strong>Fond neutre unifié :</strong> Blanc ou
                                gris clair sans distractions
                              </ListGroup.Item>
                              <ListGroup.Item className="border-0 py-2 bg-transparent">
                                <i className="fas fa-arrows-alt text-primary me-2"></i>
                                <strong>5 angles minimum :</strong> Face, dos,
                                côtés, dessus, et détail caractéristique
                              </ListGroup.Item>
                            </ListGroup>
                          </div>
                        </Col>
                          ...
                          <div className="bg-warning bg-opacity-5 p-4 rounded-3 h-100">
                            ...
                            <ListGroup variant="flush">
                              <ListGroup.Item className="border-0 py-2 bg-transparent">
                                ...
                                <strong>Transparence des défauts :</strong>{" "}
                                Photos spécifiques de chaque imperfection
                              </ListGroup.Item>
                              <ListGroup.Item className="border-0 py-2 bg-transparent">
                                <i className="fas fa-ruler-combined text-info me-2"></i>
                                <strong>Photo avec échelle :</strong> Inclure un
                                objet de référence pour la taille
                              </ListGroup.Item>
                              <ListGroup.Item className="border-0 py-2 bg-transparent">
                                <i className="fas fa-expand-alt text-success me-2"></i>
                                <strong>Détails logos/marques :</strong> Gros
                                plans sur les éléments distinctifs
                              </ListGroup.Item>
                            </ListGroup>
                          </div>
                        </Col>
                ...
                <Col lg={4}>
                  <Card className="border-primary border-2 shadow-lg mb-4">
                    <Card.Body className="p-4">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              ...
                              <small className="text-muted">0-10 ventes</small>
                            </td>
                          ...
                          <tr>
                            <td>
                              ...
                              <small className="text-muted">11-50 ventes</small>
                            </td>
                          ...
                          <tr>
                            <td>
                              ...
                              <small className="text-muted">200+ ventes</small>
                            </td>
                      ...
                      >
                        ...
                        <small>
                          Les commissions sont calculées uniquement sur le prix
                          final de vente, hors frais de livraison. Aucun frais
                          de mise en ligne ou d'abonnement.
                        </small>
                      </Alert>
                    </Card.Body>
                  </Card>

                  <Card className="border-warning border-2 shadow-lg">
                    <Card.Body className="p-4">
                      ...
                      <p className="text-dark mb-4">
                        Ces pratiques ont été validées par l'analyse des données
                        de milliers de vendeurs performants sur OSKAR.
                      </p>
            ...
            <Tab.Pane eventKey="exchanges">
              ...
              <Row className="g-4 mb-5">
                <Col md={4}>
                  <Card className="border-warning border-2 shadow-lg h-100">
                ...
                <Col md={4}>
                  <Card className="border-warning border-2 shadow-lg h-100">
                    <Card.Body className="p-4 text-center">
                      ...
                      <p className="text-dark">
                        OSKAR agit comme médiateur tiers pour garantir l'échange
                        équitable. En cas de litige, notre équipe intervient
                        pour trouver une solution satisfaisante pour toutes les
                        parties concernées.
                      </p>
                      <Badge bg="warning" className="mt-2">
              ...
              <Card className="border-warning border-2 shadow-lg mb-5">
                <Card.Body className="p-5">
                  ...
                  <p className="text-dark mb-4">
                    ...
                    d'échange, avec des réponses détaillées pour vous aider à
                    maîtriser cette fonctionnalité unique.
                  </p>
                  ...
                  <Accordion>
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        ...
                        <ul className="text-dark">
                          ...
                          <li>
                            <strong>Saisonnalité :</strong> Variation de valeur
                            selon la période de l'année
                          </li>
                          <li>
                            <strong>Rareté :</strong> Disponibilité et fréquence
                            d'apparition sur le marché
                          </li>
                          <li>
                            <strong>Accessoires inclus :</strong> Valeur ajoutée
                    ...
                    <Accordion.Item eventKey="1">
                      ...
                      <Accordion.Body>
                        <p className="text-dark">
                          OSKAR propose plusieurs solutions intelligentes pour
                          gérer les écarts de valeur :
                        </p>
                        <ul className="text-dark">
                          <li>
                            <strong>Compensation monétaire :</strong> Paiement
                            complémentaire calculé automatiquement
                          </li>
                          <li>
                            <strong>Échange multi-parties :</strong> Impliquer
                            un troisième article pour équilibrer
                          </li>
                          <li>
                            <strong>Crédit OSKAR :</strong> Solde utilisable sur
                            toute la plateforme
                          </li>
                          <li>
            ...
            <Tab.Pane eventKey="donations">
              <div className="mb-5">
                <div className="text-center mb-4">
                  <div className="bg-info bg-opacity-10 p-5 rounded-circle d-inline-block mb-4">
                  ...
                  <p className="text-dark fs-5">
                    Transformez vos invendus en actes de générosité récompensés.
                    Le programme de dons OSKAR crée une synergie unique entre
                    engagement social et avantages pratiques pour les vendeurs.
                  </p>
                </div>

                <div className="bg-info bg-opacity-10 p-5 rounded-4">
                  ...
                  <p className="text-dark mb-0 fs-5">
                    ...
                    récompensée et facilitée. Notre programme transforme le don
                    d'invendus en une expérience positive qui bénéficie à tous :
                    le vendeur obtient des avantages concrets, les associations
                    reçoivent des articles de qualité, et la communauté renforce
              ...
              <Row className="g-4 mb-5">
                <Col lg={8}>
                  <Card className="border-info border-2 shadow-lg h-100">
                    <Card.Body className="p-5">
                              ...
                              <div className="d-flex align-items-start">
                                ...
                                <div>
                                  ...
                                  <small className="text-dark">
                                    ...
                                    impôts à hauteur de 66% de la valeur du don
                            ...
                            <ListGroup.Item className="border-0 py-3">
                              <div className="d-flex align-items-start">
                                ...
                                <div>
                                  ...
                                  <small className="text-dark">
                                    Badge spécial sur votre profil augmentant la
                                    confiance des acheteurs de 35% et améliorant
                            ...
                            <ListGroup.Item className="border-0 py-3">
                              <div className="d-flex align-items-start">
                                ...
                                <div>
                                  ...
                                  <small className="text-dark">
                                    Accès au réseau exclusif des donateurs OSKAR
                                    avec opportunités de networking et avantages
                                    communautaires
                                  </small>
                                </div>
                              </div>
                ...
                <Col lg={4}>
                  <Card className="border-info border-2 shadow-lg h-100">
                    <Card.Body className="p-4">
                      ...
                      <p className="text-dark mb-4">
                        OSKAR accepte une large variété d'articles en bon état.
                        Voici les principales catégories avec leurs
                        spécifications :
                      </p>
              ...
              <Card className="border-info border-2 shadow-lg">
                <Card.Body className="p-5">
                  <h4 className="fw-bold mb-4 text-info">
            ...
            <Tab.Pane eventKey="performance">
              <div className="mb-5">
                ...
                <p className="text-dark fs-5">
                  Analysez vos performances, identifiez les opportunités
                  d'amélioration et comparez-vous à la moyenne des vendeurs
                  OSKAR.
                </p>
              </div>
          ...
          <Row className="align-items-center">
            <Col lg={8}>
              ...
              <p className="text-white-75 mb-0">
                Notre équipe de support est disponible 7j/7 pour vous aider à
                résoudre vos problèmes et optimiser vos performances.
              </p>
            </Col>
            <Col lg={4} className="text-lg-end mt-3 mt-lg-0">
              <div className="bg-white rounded-3 p-4 d-inline-block">
                <div className="text-center">
                  <div className="text-success fw-bold fs-5">
                    support@oskar.com
                  </div>
                  <small className="text-muted">Réponse sous 2 heures</small>
                </div>
              </div>
            </Col>
          </Row>
