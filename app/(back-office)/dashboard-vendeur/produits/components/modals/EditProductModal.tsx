...
export default function EditProductModal({
  ...
  const [formData, setFormData] = useState<ProductFormData>({
    ...
    categorie_uuid: product.categorie_uuid || "",
    lieu: product.lieu || "",
    condition: product.condition || "bon_etat",
    type: product.type || "",
    garantie: product.garantie || "non",
    etoile: product.etoile || "3",
  ...
  const handleRemoveImage = () => {
    ...
    // Retourner à l'image originale du produit
    setImagePreview(product.image || null);
  ...
  const handleClose = () => {
    ...
    const hasChanges =
      ...
      formData.categorie_uuid !== (product.categorie_uuid || "") ||
      formData.lieu !== (product.lieu || "") ||
      formData.condition !== (product.condition || "bon_etat") ||
      formData.type !== (product.type || "") ||
      formData.garantie !== (product.garantie || "non") ||
      formData.etoile !== (product.etoile || "3") ||
      formData.disponible !== product.disponible ||
      imageFile !== null ||
            ...
            <div className="row g-4">
              ...
              <div className="col-12">
                ...
                <div className="text-muted mt-2">
                  <small>
                    Formats acceptés: JPG, PNG, WEBP, GIF (max 5MB). Laissez
                    vide pour conserver l'image actuelle.
                  </small>
                </div>
              </div>
            </div>
              ...
              <button
                ...
                style={{
                  background: isAuthenticated
                    ...
                    : colors.oskar.grey,
                  border: `1px solid ${isAuthenticated ? colors.oskar.warningHover : colors.oskar.grey}`,
                  borderRadius: "8px",
                  fontWeight: "500",
