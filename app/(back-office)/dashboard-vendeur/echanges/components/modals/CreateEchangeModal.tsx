...
import { EchangeFormData, Category } from "@/types/echange";
...
export default function CreateEchangeModal({
  ...
  useEffect(() => {
    if (isOpen) {
      const checkAuth = () => {
        ...
        if (!authenticated) {
          setError(
            "Vous devez être connecté pour créer un échange. Redirection...",
          );
          setTimeout(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isAuthenticated) {
      setError("Vous devez être connecté pour créer un échange.");
      return;
    }
    ...
    try {
      ...
      if (response && response.success !== false) {
        setSuccessMessage(response.message || "Échange créé avec succès !");
      } else {
        throw new Error(
      ...
      let errorMessage =
        err.message || "Erreur lors de la création de l'échange";
  ...
  return (
    <div
      ...
      role="dialog"
      aria-labelledby="createEchangeModalLabel"
      aria-modal="true"
    >
            ...
            <div className="d-flex align-items-center">
              ...
              <div>
                <h5
                  ...
                  id="createEchangeModalLabel"
                >
                  Créer un Nouvel Échange
                </h5>
                <p className="mb-0 opacity-75 fs-14">
                  Proposez un objet ou service en échange
                </p>
              </div>
            </div>
            <button
              ...
              >
                <div className="d-flex align-items-center">
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <p className="mb-0">
                      Vous devez être connecté pour créer un échange.
