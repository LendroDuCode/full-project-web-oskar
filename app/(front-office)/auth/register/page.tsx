...
interface RegisterModalProps {
  ...
  // Nouveau: callback spécifique pour les vendeurs (stocke seulement les données)
  onVendeurRegistered?: (vendeurData: any) => void;
  // Callback pour ouvrir le modal de connexion après inscription
...
const RegisterModal: React.FC<RegisterModalProps> = ({
  ...
  const handleRegistrationSuccess = async (data: any, type: string) => {
    ...
    if (type === "vendeur") {
      ...
      // 3. Ouvrir le modal de connexion APRÈS UN COURT DÉLAI
      setTimeout(() => {
