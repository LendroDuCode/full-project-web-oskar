// components/PublishAdModal/EchangeForm.tsx
...
import { Category, EchangeData } from "./constantes/types";
...
const EchangeForm: React.FC<EchangeFormProps> = ({
  ...
  const setEchangeData = (newData: EchangeData) => onChange(newData);
  ...
  const renderEchangeStep2 = () => (
    <div className="p-4">
      <div className="d-flex align-items-center mb-5">
        <div className="rounded-circle bg-primary bg-opacity-10 p-3 me-3">
          <FontAwesomeIcon icon={faExchangeAlt} className="text-primary fs-3" />
        </div>
        <div>
                ...
                <div className="col-md-6">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEchangeData({ ...echangeData, prix: e.target.value })
                      }
                    />
                  </div>
                </div>
  ...
  if (step === 2) return renderEchangeStep2();
  if (step === 3) return renderEchangeStep3();
  return null;
};
