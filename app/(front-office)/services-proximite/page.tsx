// app/(front-office)/services-proximite/page.tsx
"use client";
...
export default function ServicesProximitePage() {
  ...
  useEffect(() => {
    const fetchCategoryData = async () => {
      try {
        ...
        const libelleEncoded = encodeURIComponent("Services de proximité");
  ...
  return (
    <>
              ...
              <div className="mb-3">
                ...
                <p className="lead mb-3 opacity-90">
                  {categoryData.categorie.description ||
                    "Trouvez et proposez des services locaux dans votre quartier."}
                </p>
                <div className="d-flex flex-wrap gap-2">
                  <Link
                    href="/publication-annonce?categorie=Services de proximité"
                  ...
                  <Link
                    href="/publication-annonce?type=don&categorie=Services de proximité"
          ...
          <div className="row g-3">
            ...
            <div className="col-3">
              <div className="text-center">
                ...
                <div className="text-muted small">Services payants</div>
              </div>
            </div>
            <div className="col-3">
              <div className="text-center">
                ...
                <div className="text-muted small">Services gratuits</div>
              </div>
            </div>
            <div className="col-3">
              <div className="text-center">
                ...
                <div className="text-muted small">Échanges de services</div>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div className="mb-2">
                      <p className="small text-muted mb-1">
                        <i
                          ...
                          style={{ color: colors.oskar.green }}
                        ></i>
                        <strong>Réparations :</strong> Plomberie, électricité,
                        bricolage
                      </p>
                    </div>
                    <div className="mb-2">
                      <p className="small text-muted mb-1">
                        <i
                          className="fas fa-chalkboard-teacher me-1"
                          style={{ color: "#2196F3" }}
                        ></i>
                        <strong>Cours :</strong> Scolaire, musique, langues
                      </p>
                    </div>
                    <div className="mb-2">
                      <p className="small text-muted mb-1">
                        <i
                          className="fas fa-baby me-1"
                          style={{ color: "#9C27B0" }}
                        ></i>
                        <strong>Garde :</strong> Enfants, animaux, personnes
                        âgées
                      </p>
                    </div>
                    <div>
                      <p className="small text-muted mb-0">
                        <i
                          className="fas fa-utensils me-1"
                          style={{ color: "#FF9800" }}
                        ></i>
                        <strong>Divers :</strong> Ménage, jardinage, cuisine
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-xl-9 col-lg-8">
                ...
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <div>
                    <h2 className="h5 fw-bold mb-0">
                      Services disponibles près de chez vous
                    </h2>
                  </div>
                    ...
                    <div className="card border-0 shadow-sm h-100">
                      <div className="card-body p-3">
                        <div className="d-flex align-items-start">
                          ...
                          <div>
                            <h6 className="fw-bold mb-1">Économie locale</h6>
                            <p className="small text-muted mb-2">
                              Soutenez les talents de votre quartier et
                      ...
                      <div className="card-body p-3">
                        <div className="d-flex align-items-start">
                          ...
                          <div>
                            ...
                            <p className="small text-muted mb-2">
                              Nos recommandations pour des échanges sécurisés.
                            </p>
                            <ul className="list-unstyled small mb-0">
                              <li className="mb-1">
                                <i
              ...
              >
                ...
                <p className="small text-muted mb-3">
                  Proposez vos services à votre communauté
                </p>
        ...
        <div className="container">
          <div className="text-center mb-4">
            ...
            <p className="text-muted small">
              Tout sur les services de proximité
            </p>
          </div>
          <div className="row g-3">
            <div className="col-md-6">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body p-3">
                  ...
                  <p className="small text-muted mb-0">
                    Consultez les tarifs pratiqués dans votre région. Précisez
                    clairement ce qui est inclus dans le prix.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body p-3">
                  ...
                  <p className="small text-muted mb-0">
                    Consultez les avis et notes du prestataire. N'hésitez pas à
                    demander des références ou un devis détaillé.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="card-body p-3">
                  <h6 className="fw-semibold mb-2">
                    <i
                      ...
                      style={{ color: colors.oskar.green, fontSize: "0.9rem" }}
                    ></i>
                    Puis-je offrir des services gratuitement ?
                  </h6>
                  <p className="small text-muted mb-0">
                    Oui ! Vous pouvez proposer des services gratuits dans
            ...
            <div className="col-md-6">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body p-3">
                  ...
                  <p className="small text-muted mb-0">
                    Privilégiez les rencontres en lieu public, établissez un
                    contrat simple et utilisez des moyens de paiement sécurisés.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-4">
        <div className="container">
          <h3 className="h5 fw-bold mb-3">Services les plus demandés</h3>
          <div className="row g-3">
            <div className="col-md-3 col-6">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center p-3">
                  ...
                  <h6 className="fw-semibold mb-1">Bricolage</h6>
                  <p className="small text-muted mb-0">Réparations diverses</p>
                </div>
              </div>
            </div>
            <div className="col-md-3 col-6">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center p-3">
                  ...
                  <h6 className="fw-semibold mb-1">Cours particuliers</h6>
                  <p className="small text-muted mb-0">Soutien scolaire</p>
                </div>
              </div>
            </div>
            <div className="col-md-3 col-6">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center p-3">
                  ...
                  <h6 className="fw-semibold mb-1">Garde d'enfants</h6>
                  <p className="small text-muted mb-0">Baby-sitting</p>
                </div>
              </div>
            </div>
            <div className="col-md-3 col-6">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body text-center p-3">
                  ...
                  <h6 className="fw-semibold mb-1">Cours de cuisine</h6>
                  <p className="small text-muted mb-0">Ateliers culinaires</p>
                </div>
              </div>
            </div>
          </div>
