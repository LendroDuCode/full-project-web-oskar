...
export const API_ENDPOINTS = {
  ...
  AUTH: {
    ...
    VENDEUR: {
      ...
      INSCRIPTION_VIA_OTP: withBaseUrl("/auth/vendeur/register-with-otp"),
      VALIDE_OPT: withBaseUrl("/auth/vendeur/verify-otp-and-login"),
      RENVOYER_OTP: withBaseUrl("/auth/vendeur/resend-otp"),
      MOT_DE_PASSE_OUBLIE: withBaseUrl("/auth/vendeur/forgot-password"),
      REINITIALISER_MOT_DE_PASSE: withBaseUrl("/auth/vendeur/reset-passwor"),
    ...
    UTILISATEUR: {
      ...
      INSCRIPTION_VIA_OTP: withBaseUrl("/auth/utilisateur/register-with-otp"),
      VALIDE_OPT: withBaseUrl("/auth/utilisateur/verify-otp-and-login"),
      RENVOYER_OTP: withBaseUrl("/auth/utilisateur/resend-otp"),
      MOT_DE_PASSE_OUBLIE: withBaseUrl("/auth/utilisateur/forgot-password"),
      REINITIALISER_MOT_DE_PASSE: withBaseUrl("/auth/utilisateur/reset-password"),
      ...
      EXCHANGE_TOKEN_GOOGLE: withBaseUrl("/auth/utilisateur/google/exchange"),
      FACEBOOK: withBaseUrl("/auth/utilisateur/facebook/connexion"),
  ...
  VENDEURS: {
    ...
    UPLOADER_REGISTRE_COMMERCE: withBaseUrl("auth/vendeur/upload-registre-commerce"),
    GOOGLE_AUTH: withBaseUrl("/auth/vendeur/google/connexion"),
    FACEBOOK: withBaseUrl("/auth/vendeur/facebook/connexion"),
  ...
  PRODUCTS: {
    ...
    UPDATE: (uuid: string) => withBaseUrl(`/produits/modifier/${uuid}`),
    ...
    LISTE_PRODUITS_PUBLIES: withBaseUrl("/produits/tous-produits-publie"),
    LISTE_PRODUITS_EN_ATTENTE: withBaseUrl("/produits/tous-produits-en-attente"),
    LISTE_PRODUITS_BLOQUES: withBaseUrl("/produits/tous-produits-en-bloques"),
...
CATEGORIES: {
  ...
  DONS: {
    ...
    LISTE_TOUS_DON_PUBLIE: withBaseUrl("/dons/liste-tous-dons-publies"),
    LISTE_TOUS_DON_EN_ATTENTE: withBaseUrl("/dons/liste-tous-dons-en-attente"),
    LISTE_TOUS_DON_BLOQUES: withBaseUrl("/dons/liste-tous-dons-bloques"),
  ...
  ECHANGES: {
    ...
    LISTE_ECHANGES_EN_ATTENTE: withBaseUrl("/echanges/liste-de-toutes-echanges-en-attente"),
    LISTE_ECHANGES_PUBLIE: withBaseUrl("/echanges/liste-de-toutes-echanges-publies"),
    LISTE_ECHANGES_BLOQUE: withBaseUrl("/echanges/liste-de-toutes-echanges-bloques"),
